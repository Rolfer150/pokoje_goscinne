<x-layouts.app pageTitle="Kontakt">
    ...
    <div class="container mx-auto">
        <div class="px-8 py-10 md:px-28 mx-auto">
            <h2 class="text-xl mb-6 text-center">Napisz do nas pytanie lub zadzwoń</h2>

            {{--  Panel z danymi kontaktowymi  --}}
            <div class="grid grid-cols-1 md:grid-cols-3 gap-x-6 gap-y-6 lato-bold">

                {{--  Panel numeru telefonu  --}}
                <div class="flex flex-col justify-center items-center py-8 rounded-md bg-emerald-400/50 text-emerald-700 hover:bg-emerald-600 hover:text-white transition duration-200 ease-in">
