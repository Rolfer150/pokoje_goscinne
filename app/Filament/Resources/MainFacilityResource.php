...
use App\Filament\Resources\MainFacilityResource\Pages;
use App\Filament\Resources\MainFacilityResource\RelationManagers;
...
class MainFacilityResource extends Resource
{
    ...
    {
        return [
            'index' => Pages\ManageMainFacilities::route('/'),
        ];
    }
}
